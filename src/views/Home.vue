    ...
    <section class="py-20 bg-white">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-fade-in-up animation-delay-200">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">Em apenas 3 passos simples, você pode começar a usar o Consentir para suas necessidades de segurança jurídica.</p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
