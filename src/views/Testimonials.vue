    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600">
                      Veja o que nossos clientes dizem sobre o Consentir
        </p>
      </div>
...
const getDefaultTestimonials = () => {
  return [
    {
      id: 1,
              content: 'O Consentir revolucionou a forma como gerenciamos nossos projetos. A interface é intuitiva e as funcionalidades são exatamente o que precisávamos.',
    ...
    {
      id: 2,
              content: 'Desde que começamos a usar o Consentir, nossa produtividade aumentou em 40%. A colaboração entre as equipes nunca foi tão eficiente.',
    ...
    {
      id: 4,
              content: 'A facilidade de uso do Consentir é impressionante. Em poucos dias nossa equipe já estava dominando todas as funcionalidades.',
    ...
    {
      id: 5,
              content: 'Migrar para o Consentir foi a melhor decisão que tomamos. Conseguimos centralizar todos os nossos projetos em um só lugar.',
    ...
    {
      id: 6,
              content: 'O Consentir nos ajudou a organizar melhor nossos processos e a ter uma visão clara do andamento de todos os projetos.',
