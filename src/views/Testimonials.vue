    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600">
          Veja o que nossos clientes dizem sobre o Trust Me
        </p>
      </div>
      ...
      <div class="mt-16 bg-trust-600 rounded-lg p-8 text-center text-white">
        ...
        <p class="text-trust-100 mb-6">
          Junte-se a milhares de empresas que já transformaram sua gestão com o Trust Me.
        </p>
        <router-link
          to="/registro"
...
const getDefaultTestimonials = () => {
  return [
    ...
    {
      id: 4,
      content: 'A facilidade de uso do Trust Me é impressionante. Em poucos dias nossa equipe já estava dominando todas as funcionalidades.',
    ...
    {
      id: 5,
      content: 'Migrar para o Trust Me foi a melhor decisão que tomamos. Conseguimos centralizar todos os nossos projetos em um só lugar.',
    ...
    {
      id: 6,
      content: 'O Trust Me nos ajudou a organizar melhor nossos processos e a ter uma visão clara do andamento de todos os projetos.',
